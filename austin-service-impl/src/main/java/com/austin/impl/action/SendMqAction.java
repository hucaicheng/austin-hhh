    ...
    public void process(ProcessContext<SendTaskModel> context) {
        ...
        try {
            if (BusinessCode.COMMON_SEND.getCode().equals(context.getCode())) {
                String message = JSON.toJSONString(sendTaskModel.getTaskInfos(), SerializerFeature.WriteClassName);
            ...
            log.error("send {} fail! e:{},params:{}", mqPipeline, Throwables.getStackTraceAsString(e)
                    , JSON.toJSONString(CollUtil.getFirst(sendTaskModel.getTaskInfos().listIterator())));
        }
    }
