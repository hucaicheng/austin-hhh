...
import com.austin.common.enums.IdType;
...
public class AfterParamCheckAction implements BusinessProcess<SendTaskModel> {
    ...
    public void process(ProcessContext<SendTaskModel> context) {
        ...
        List<TaskInfo> taskInfo = sendTaskModel.getTaskInfos();
    ...
    private void filter(List<TaskInfo> taskInfo, String regexExp) {
        ...
        while (iterator.hasNext()){
            ...
            if (CollUtil.isNotEmpty(illegalPhone)){
                ...
                log.error("拦截的非法接收者: messageTemplateId:{} find illegal receiver!{}", task.getMessageTemplateId(), JSON.toJSONString(illegalPhone));
            }
